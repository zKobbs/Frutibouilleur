...
var optgroupBoy = document.getElementById('optgroupBoy');
var optgroupGirl = document.getElementById('optgroupGirl');
var optgroupMixed = document.getElementById('optgroupMixed');
...
var hairs = [
    ['Mecapo', 'ch_mecapo', 'transparent.png', 'boy'],
    ['Gomhi', 'ch_gomhi', 'ch_gomhi_c.svg', 'boy'],
    ['Norho', 'ch_norho', 'transparent.png', 'boy'],
    ['Sylern', 'ch_sylern', 'transparent.png', 'boy'],
    ['Hanir', 'cf_hanir', 'cf_hanir_c.svg', 'girl'],
    ['Lusnar', 'cf_lusnar', 'cf_lusnar_c.svg', 'girl'],
    ['Losho', 'cf_losho', 'cf_losho_c.svg', 'girl'],
    ['Lysurn', 'cf_lysurn', 'cf_lysurn_c.svg', 'girl'],
    ['Colnor', 'ch_colnor', 'transparent.png', 'boy'],
    ['Merlag', 'ch_merlag', 'transparent.png', 'boy'],
    ['Leglys', 'cf_leglys', 'cf_leglys_c.svg', 'mixed'],
    ['Selho', 'ch_selho', 'ch_selho_c.svg', 'boy'],
    ['Barsil', 'ch_barsil', 'transparent.png', 'boy'],
    ['Huha', 'cf_huha', 'transparent.png', 'girl'],
    ['Ernleg', 'cf_ernleg', 'cf_ernleg_c.svg', 'girl'],
    ['Bersul', 'ch_bersul', 'transparent.png', 'boy'],
    ['Culbur', 'ch_culbur', 'ch_culbur_c.svg', 'boy'],
    ['Solnar', 'ch_solnar', 'transparent.png', 'boy'],
...
hairs.forEach(hairCut => {
    var option = document.createElement("option");
    option.value = hairCut[1];
    option.text = hairCut[0];
    switch (hairCut[3]) {
        case 'boy':
            optgroup = optgroupBoy;
            break;
        case 'girl':
            optgroup = optgroupGirl;
            break;
        default:
            optgroup = optgroupMixed;
    }
